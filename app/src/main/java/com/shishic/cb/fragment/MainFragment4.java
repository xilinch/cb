            ...
            public void onResponse(String o) {
                ...
                try {
                    ...
                    if(listJSONArray != null){
                        List<NewsBean> list = new Gson().fromJson(listJSONArray.toString(), new TypeToken<List<NewsBean>>() {
                        }.getType());
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jsonArray != null && jsonArray.length() > 0) {
                        adTextBeans = new Gson().fromJson(jsonArray.toString(), new TypeToken<List<ADTextBean>>() {
                        }.getType());
                        //组装一次所有的内容
                        ...
                        for (int i = 0; i < size; i++) {
                            ...
                            Glide.with(getContext()).load(adTextBeans.get(i).getContent()).centerCrop().placeholder(R.mipmap.banner1).into(imageView);
